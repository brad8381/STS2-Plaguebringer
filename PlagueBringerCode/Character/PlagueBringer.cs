...
{
    public const string CharacterId = "PlagueBringer";
    ...
    public override string CustomVisualPath =>
        "res://PlagueBringer/scenes/plaguebringer_character.tscn";

    public override string CustomCharacterSelectBg =>
        "res://PlagueBringer/scenes/plaguebringer_select_bg.tscn";

    public override string CustomRestSiteAnimPath =>
        "res://PlagueBringer/scenes/plaguebringer_rest_site.tscn";
