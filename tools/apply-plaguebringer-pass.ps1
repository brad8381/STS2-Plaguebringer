...
$touchFiles = @(
    "$repo\PlagueBringer\images\charui\char_select_char_name.png",
    "$repo\PlagueBringer\images\charui\char_select_char_name_locked.png",
    "$repo\PlagueBringerCode\Character\PlagueBringer.cs",
    "$repo\PlagueBringerCode\Character\PlagueBringerCardPool.cs",
    "$repo\PlagueBringerCode\Character\PlagueBringerIdle.cs",
    "$repo\PlagueBringerCode\Character\PlagueBringerSelectSway.cs",
    "$repo\PlagueBringerCode\Mechanics\SpecimenActions.cs",
    "$repo\PlagueBringerCode\Mechanics\SpecimenUiPatch.cs",
    "$repo\PlagueBringerCode\Powers\SpecimenPower.cs",
    "$repo\PlagueBringerCode\Cards\ConcentratedDose.cs",
    "$repo\PlagueBringer\scenes\plaguebringer_character.tscn",
    "$repo\PlagueBringer\scenes\plaguebringer_select_bg.tscn",
    "$repo\PlagueBringer\scenes\plaguebringer_rest_site.tscn"
)
...
$charui = "$repo\PlagueBringer\images\charui"
...
$path = "$repo\PlagueBringerCode\Character\PlagueBringerCardPool.cs"

$text = @"
using BaseLib.Abstracts;
using Godot;

namespace PlagueBringer.PlagueBringerCode.Character;
...
public class PlagueBringerCardPool : CustomCardPoolModel
{
    ...
    public override string BigEnergyIconPath =>
        "res://PlagueBringer/images/charui/energy_big.png";

    public override string TextEnergyIconPath =>
        "res://PlagueBringer/images/charui/energy_text.png";
...
$energyScene = "$repo\PlagueBringer\scenes\plaguebringer_energy_counter.tscn"

$text = @'
[gd_scene load_steps=2 format=3]

[ext_resource type="Texture2D" path="res://PlagueBringer/images/charui/energy_counter.png" id="1_energy"]
...
$characterPath = "$repo\PlagueBringerCode\Character\PlagueBringer.cs"
...
if ($c -notmatch "CustomEnergyCounterPath") {
    ...
    public override string CustomMerchantAnimPath =>
        "res://PlagueBringer/scenes/plaguebringer_merchant.tscn";
'@
    ...
    public override string CustomEnergyCounterPath =>
        "res://PlagueBringer/scenes/plaguebringer_energy_counter.tscn";
'@
...
$path = "$repo\PlagueBringerCode\Powers\SpecimenPower.cs"
...
namespace PlagueBringer.PlagueBringerCode.Powers;
...
$path = "$repo\PlagueBringerCode\Mechanics\SpecimenActions.cs"

$text = @'
using PlagueBringer.PlagueBringerCode.Powers;
using MegaCrit.Sts2.Core.Commands;
using MegaCrit.Sts2.Core.Entities.Creatures;
using MegaCrit.Sts2.Core.GameActions.Multiplayer;
using MegaCrit.Sts2.Core.Models;

namespace PlagueBringer.PlagueBringerCode.Mechanics;
...
$path = "$repo\PlagueBringerCode\Mechanics\SpecimenUiPatch.cs"
...
$path = "$repo\PlagueBringerCode\Cards\ConcentratedDose.cs"
...
namespace PlagueBringer.PlagueBringerCode.Cards;
...
$path = "$repo\PlagueBringerCode\Character\PlagueBringerIdle.cs"
...
public partial class PlagueBringerIdle : Node2D
{
    ...
    public override void _Ready()
    {
        ...
        _idleTexture = GD.Load<Texture2D>(
            "res://PlagueBringer/images/character/idle_pose.png");

        _attackTexture = GD.Load<Texture2D>(
            "res://PlagueBringer/images/character/attack_pose.png");

        _castTexture = GD.Load<Texture2D>(
            "res://PlagueBringer/images/character/cast_pose.png");
...
$combatScene = "$repo\PlagueBringer\scenes\plaguebringer_character.tscn"
$c = [System.IO.File]::ReadAllText($combatScene)

$c = $c.Replace(
    'path="res://PlagueBringer/images/character/plaguebringer_combat.png"',
    'path="res://PlagueBringer/images/character/idle_pose.png"'
)
...
$path = "$repo\PlagueBringerCode\Character\PlagueBringerSelectSway.cs"
...
$selectScene = "$repo\PlagueBringer\scenes\plaguebringer_select_bg.tscn"
$c = [System.IO.File]::ReadAllText($selectScene)

$c = $c.Replace(
    'path="res://PlagueBringer/images/character/plaguebringer_combat.png"',
    'path="res://PlagueBringer/images/character/select_pose.png"'
)
...
$restScene = "$repo\PlagueBringer\scenes\plaguebringer_rest_site.tscn"

$text = @'
[gd_scene load_steps=2 format=3]

[ext_resource type="Texture2D" path="res://PlagueBringer/images/character/rest_pose.png" id="1_texture"]
...
Remove-Item `
    "$repo\PlagueBringerCode\Cards\Miasma.cs" `
    -ErrorAction SilentlyContinue

Remove-Item `
    "$repo\PlagueBringerCode\Powers\MiasmaPower.cs" `
    -ErrorAction SilentlyContinue
